  ...
  return (
    <div className="flex justify-center items-center">
      <div className='absolute top-10'>
        ...
        <p className='mt-3 text-lg'>To continue, please log in with your Google account</p>
      </div>

      <Image src="https://go-trade-local-product-123.s3.us-east-2.amazonaws.com/laptop.jpg" alt="" className="" />
